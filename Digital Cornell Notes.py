...
top.iconphoto(True, PhotoImage(file="/home/zacksollenberger/Desktop/TRANSFER/Programming/Notes/thingy.png"))
...
#top.bind("<Control-s>", get_notes_as_string)
#top.bind("<Control-o>", ctrl_o_open)
...
#Section to handle opening files directly
